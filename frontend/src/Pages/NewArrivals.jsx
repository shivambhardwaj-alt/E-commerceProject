...
const NewArrivals = () => {
  ...
  // Here i will filter all the data with the respect to new Arrivals ;

  const [newArrivals, setNewArrivals] = useState([]);


  useEffect(() => {
    // const filteredItem = winterProducts.filter(item => item.newArrival === true);
    const sorted = winterProducts.toSorted((a, b) => b.createdAt - a.createdAt);
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 p-2">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-end px-6 md:px-12 text-white">
                <span className="inline-block mb-3 w-fit px-4 py-1 text-xs md:text-sm
                                 rounded-full bg-white/20 backdrop-blur-md
                                 border border-white/30 tracking-wide self-center prata-regular">

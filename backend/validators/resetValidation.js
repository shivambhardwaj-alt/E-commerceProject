...
const createEmailValidation = [
    ...
    body("email").optional({ checkFalsy: true }).isEmail().withMessage("Invalid Email").bail(),
    body("phone").optional({ checkFalsy: true }).isMobilePhone().withMessage("Invalid Phone Number").bail(),
];
